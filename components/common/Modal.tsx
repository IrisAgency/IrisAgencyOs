...
const Modal: React.FC<ModalProps> = ({
    ...
    return (
        <div className={`fixed inset-0 z-50 flex items-center justify-center p-4 transition-opacity duration-200 ${isOpen ? 'opacity-100' : 'opacity-0'}`}>
            ...
            {/* Modal Content */}
            <div className={`bg-white rounded-xl shadow-2xl w-full ${sizeClasses[size]} overflow-hidden relative transform transition-all duration-200 ${isOpen ? 'scale-100 translate-y-0' : 'scale-95 translate-y-4'}`}>
