      ...
      <div className="py-4 px-5 min-w-0">
        <div className="flex items-start gap-2.5">
          ...
          <div className="flex-1 min-w-0">
            ...
            {item.mainIdea && <BidiText text={item.mainIdea} className="mt-1 text-xs text-gray-600 leading-relaxed line-clamp-2" />}
            {item.brief && <BidiText text={item.brief} className="mt-1 text-xs text-gray-500 leading-relaxed line-clamp-3" />}
            {item.notes && <BidiText text={item.notes} className="mt-1 text-[11px] text-gray-400 italic line-clamp-2" />}
          </div>
        </div>
      </div>
