...
import { LayoutDashboard, FolderKanban, CheckSquare, Clapperboard, DollarSign, Users, PieChart, Settings, Hexagon, Building2, Layers, Network, ShieldAlert } from 'lucide-react';
...
const Sidebar: React.FC<SidebarProps> = ({ activeView, setActiveView, currentUserRole }) => {
  ...
  return (
    ...
    <aside 
      className="w-64 flex flex-col h-screen fixed left-0 top-0 border-r border-white/10 z-20 transition-colors duration-300"
