      ...
      <div className="h-full flex items-center justify-between px-4 lg:px-6 max-w-[1280px] mx-auto gap-4">
        ...
        <div className="flex items-center gap-3 shrink-0">
          ...
          <div className="relative" ref={notificationRef}>
            ...
            {showNotifications && (
              <div className="fixed left-1/2 -translate-x-1/2 top-[var(--header-h)] mt-1 w-[calc(100vw-24px)] sm:absolute sm:left-auto sm:translate-x-0 sm:top-auto sm:right-0 sm:mt-3 sm:w-96 bg-[var(--dash-surface)] rounded-xl shadow-xl border border-[var(--dash-glass-border)] overflow-hidden animate-in fade-in zoom-in duration-200 sm:origin-top-right z-50">
