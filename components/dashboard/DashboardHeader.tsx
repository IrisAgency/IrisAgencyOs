...
const DashboardHeader: React.FC<DashboardHeaderProps> = ({
  ...
  return (
    <header className="bg-iris-black text-iris-white rounded-2xl p-6 flex flex-col justify-between">
      <div>
        <div className="flex justify-between items-start">
          <div>
            <h1 className="text-3xl font-bold text-iris-white">
              {selectedDate.toLocaleDateString('en-US', { month: 'long', year: 'numeric' })}
            </h1>
            <p className="text-iris-white/70 mt-1">
          ...
          <div className="flex items-center gap-4">
            <div className="relative">
              ...
              <input
                ...
                className="bg-iris-white/10 border-none rounded-full w-72 pl-10 pr-4 py-2.5 text-iris-white placeholder-iris-white/50 focus:ring-2 focus:ring-iris-red"
              />
            </div>
            <button className="flex items-center gap-2 bg-iris-red text-iris-white font-semibold px-4 py-2.5 rounded-full hover:bg-iris-red/90 transition-colors">
